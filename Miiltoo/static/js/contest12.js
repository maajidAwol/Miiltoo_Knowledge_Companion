...
var quizData = []; // To store fetched quiz data
var score = 0;
...
`;
  fetch("/contest_request", {
    ...
    .then((data) => {
      ...
      if (data && data.physics && data.physics.quiz) {
        quizData = data.physics.quiz;
        buildQuiz();
...
var quizContainer = document.getElementById("quiz-container1");
